...
fn main() {
    ...
    dag.add_edge(2, 3, None); // Node 2 already auto-created, Node 3 exists
    println!("{}\n", dag.render());
    ...
    dag.add_edge(1, 3, None); // 3 auto-created
    dag.add_edge(2, 4, None); // 4 auto-created
    dag.add_edge(3, 4, None); // 4 already auto-created
    dag.add_edge(4, 5, None); // 5 exists
    println!("{}\n", dag.render());
